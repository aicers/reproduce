...
impl Giganto {
        ...
        T: Serialize + TryFromZeekRecord + Unpin + Debug,
    {
        ...
        info!(
            "Network event type data sent to data store.\n
    ...
    async fn send_oplog(
        ...
        info!(
            "Operation log type data sent to data store.\n
            Last line: {}, Success: {}, Failed: {}",
        ...
        T: Serialize + TryFromSysmonRecord + Unpin + Debug,
    {
        ...
        self.init_msg = true;
        info!(
            "Sysmon event type data sent to data store.\n
            Last line: {}, Success: {}, Failed: {}",
            pos.line(),
            success_cnt,
            failed_cnt
        ...
        T: Serialize + ParseNetflowDatasets + Unpin + Debug,
    {
        ...
        info!(
            "Netflow type data sent to data store.\n
            Statistics: {:?}",
            stats
        );
        ...
        T: Serialize + ParseSecurityLog + Unpin + Debug,
    {
        ...
        info!(
            "Security log type data sent to data store.\n
            Last line: {}, Success: {}, Failed: {}",
            cnt, success_cnt, failed_cnt
        );
