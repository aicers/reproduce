...
mod giganto_timestamp_tests {
    ...
    fn parse_giganto_timestamp_negative() {
        ...
        // jiff normalizes negative timestamps: -1000000.5s becomes -999999 seconds - 500000000 nanos
        // This preserves the total nanoseconds from epoch: -1000000*1e9 + 500000000
