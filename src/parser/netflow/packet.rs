...
pub mod test_utils {
    ...
    pub fn netflow9_header_fixture(source_id: u32) -> Netflow9Header {
        Netflow9Header {
            version: 9,
            count: 1,
            sys_uptime: 0,
...
mod tests {
    ...
    use super::*;
    use crate::parser::netflow::ParseNetflowDatasets;
    use crate::parser::netflow::Stats;
    use crate::parser::netflow::fields::DataTypes;
    use crate::parser::netflow::statistics::ProcessStats;
    use crate::parser::netflow::templates::{Template, TemplatesBox};
