...
use super::{
    DEFAULT_IPADDR, DEFAULT_PORT, Mf2, ParseSecurityLog, SecurityLogInfo, SecurityLogParseResult,
    proto_to_u8,
};
...
fn parse_mf2_timestamp_ns(datetime: &str) -> SecurityLogParseResult<i64> {
    Ok(
...
mod tests {
    ...
    use super::*;
    use crate::parser::security_log::{PROTO_TCP, PROTO_UDP};
